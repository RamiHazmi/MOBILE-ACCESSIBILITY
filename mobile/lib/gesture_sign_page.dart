// mobile/lib/gesture_sign_page.dart � MediaPipe Gesture Recognizer
import 'dart:async';
import 'dart:convert';
...
class GestureSignPage extends StatefulWidget {
  const GestureSignPage({super.key});

  @override
  State<GestureSignPage> createState() => _GestureSignPageState();
}

class _GestureSignPageState extends State<GestureSignPage>
    ...
    setState(() {
      if (type == 'ready') {
        ...
        _statusMsg = _serviceOk
            ...
            : 'ASL CNN model not found — check models/sign/new/asl_cnn.pt';
